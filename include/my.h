...
//removes the substring between the given index of the string.
void remove_substring(char**, unsigned int, unsigned int);

//inserts the string at the given index of the string.
void insert_str_at(char**, char*, unsigned int);
